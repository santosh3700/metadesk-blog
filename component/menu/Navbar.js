...
export default function Navbar() {
    ...
    return (
        ...
        <Box zIndex={'9999'} >
            <Box bg={'white'} px={{ base: "4", lg: "16" }} borderBottom={'1px solid #e2e8f0'} >
                {/* <Flex
                ...
                <Grid templateColumns={{ md: "3fr 9fr ", sm: "repeat(2, 1fr)" }} textColor="white" gap={4} py={{ base: '6', md: '12' }} >
                    <Box><Link
                        href="/"
                    >
                        <Image
                ...
                >
                    ...
                    <Flex>
                        <Icon as={FaRegMoon} onClick={onOpen} boxSize={6} mr={'4'} />

            ...
            <Box >
                <Box >
                    <Container as={Stack} maxW={'6xl'} py={10}>
                        <SimpleGrid
                            templateColumns={{ base: '1fr 1fr ', md: '1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr  4fr' }}
                            spacing={4}>

                            <Stack align={'flex-start'}  >
                                <Heading size='sm' as='h5'  >Support</Heading>
                                <Link href={'#'}>Meta</Link>
                                <Link href={'#'}>Prices</Link>
                            </Stack>

                            <Stack align={'flex-start'}  >
                                <Heading size='sm' as='h5'  >About</Heading>
                                <Link href={'#'}>Meta</Link>
                                <Link href={'#'}>Prices</Link>
                            </Stack>
                            ...
                            <Stack spacing={6} alignItems={'flex-start'} display={{ base: 'none', md: 'block' }}>
                                <Link
                                    href="/"
                                >
                                    <Image
                        ...
                        <Stack spacing={6} alignItems={'flex-start'} display={{ base: 'block', md: 'none' }} mt={'30px !important'}>
                            <Link
                                href="/"
                            >
                                <Image

...
function PostItem({
  ...
  const uri = postItem.uri; //const date = new Date()
...
const ArchiveHeroSection = props => {
  ...
  const breadcrumb = router.asPath.split('/'); //   console.log('checkherosection', breadcrumb);
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [' ', /*#__PURE__*/_jsx(Box, {
      ...
      children: /*#__PURE__*/_jsxs(Box, {
        ...
        alignItems: "center" //   background="url(https://akm-img-a-in.tosshub.com/aajtak/resource/img/lf-circel.png), url(https://akm-img-a-in.tosshub.com/aajtak/resource/img/rh-circel.png)"
        ,
          ...
          children: [/*#__PURE__*/_jsx(Text, {
            ...
            children: breadcrumb.map((item, key) => {
              ...
              return /*#__PURE__*/_jsxs("span", {
                children: [name, key < breadcrumb.length - 1 ? /*#__PURE__*/_jsx(ChevronRightIcon, {}) : null]
              }, key);
            })
          }), /*#__PURE__*/_jsx(Flex, {
            alignItems: 'center',
...
function PostList({
  ...
  const tempArr = [1, 2, 3];
  const tempArrTwo = [1, 2, 3, 4]; //   console.log('chekcsulg', data.edges.length);
  ...
  const {
    ...
    sectionBData,
    sectionCData
  } = section; // console.log('checkcat', sectionAData);

  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/jsx_runtime.jsx(seo_ArchiveSeo, {
      data: data,
      pageType: pageType,
      pageName: pageName
      ...
      children: [/*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Heading, {
        ...
        gap: 3,
        my: 6,
        children: [data.edges && data.edges.slice(0, 1).map((item, index) => {
          ...
          children: /*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Grid, {
            ...
            children: data.edges && data.edges.slice(1, 3).map((item, index) => {
              ...
              const tagName = item === null || item === void 0 ? void 0 : (_item$node2 = item.node) === null || _item$node2 === void 0 ? void 0 : (_item$node2$tags = _item$node2.tags) === null || _item$node2$tags === void 0 ? void 0 : (_item$node2$tags$edge = _item$node2$tags.edges[0]) === null || _item$node2$tags$edge === void 0 ? void 0 : (_item$node2$tags$edge2 = _item$node2$tags$edge.node) === null || _item$node2$tags$edge2 === void 0 ? void 0 : _item$node2$tags$edge2.name; // console.log('checkiteem', item);
        ...
        gap: 6,
        my: 20,
        children: [data.edges.slice(3, 4).map((item, index) => {
          var _item$node3, _item$node4;

          // console.log('catmap', videoId);
          const author = item === null || item === void 0 ? void 0 : (_item$node3 = item.node) === null || _item$node3 === void 0 ? void 0 : _item$node3.author.node; // const imagePath = item.node.featuredImage?.node.sourceUrl;

          const videoId = item.node.youtube.videoId; // const imagePath =
          ...
          return item && item.node && /*#__PURE__*/jsx_runtime.jsx(next_link["default"], {
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
              cursor: 'pointer',
              children: [(item === null || item === void 0 ? void 0 : (_item$node4 = item.node) === null || _item$node4 === void 0 ? void 0 : _item$node4.featuredImage) && /*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Img, {
                src: item.node.featuredImage.node.sourceUrl,
                alt: item.node.title
              }), /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
                my: '2',
                children: [/*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Heading, {
                  ...
                  mt: "2",
                  alignItems: 'center',
                  children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Text, {
                    color: primaryTextColor,
                    fontWeight: 'bold',
                    children: ["By ", /*#__PURE__*/jsx_runtime.jsx("b", {
          ...
          children: data.edges.slice(4, 7).map((item, index) => {
            var _item$node5, _item$node$featuredIm, _item$node6;

            const author = item === null || item === void 0 ? void 0 : (_item$node5 = item.node) === null || _item$node5 === void 0 ? void 0 : _item$node5.author.node;
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
                ...
                children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Grid, {
                  ...
                  children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
                    ...
                    children: (item === null || item === void 0 ? void 0 : (_item$node6 = item.node) === null || _item$node6 === void 0 ? void 0 : _item$node6.featuredImage) && /*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Img, {
                      h: '100%',
                      objectFit: 'cover',
                      src: item.node.featuredImage.node.sourceUrl,
                      alt: item.node.title
      ...
      }), /*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Divider, {}), /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
        py: 6,
        children: [/*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Heading, {
          as: "h2",
          size: 'lg',
          ...
          children: sectionAData.edges.slice(0, 4).map((item, index) => {
            var _item$node7, _item$node$featuredIm2;

            const author = item === null || item === void 0 ? void 0 : (_item$node7 = item.node) === null || _item$node7 === void 0 ? void 0 : _item$node7.author.node;
            const imagePath = (_item$node$featuredIm2 = item.node.featuredImage) === null || _item$node$featuredIm2 === void 0 ? void 0 : _item$node$featuredIm2.node.sourceUrl;
            return item && item.node && /*#__PURE__*/jsx_runtime.jsx(next_link["default"], {
              href: item.node.slug,
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Grid, {
                cursor: 'pointer',
      ...
      }), /*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Divider, {}), /*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Box, {
        py: 6,
        children: /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Grid, {
          templateColumns: {
            md: '6fr 6fr',
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
            children: [/*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Heading, {
              ...
              var _item$node8, _item$node$featuredIm3;

              const author = item === null || item === void 0 ? void 0 : (_item$node8 = item.node) === null || _item$node8 === void 0 ? void 0 : _item$node8.author.node;
              const imagePath = (_item$node$featuredIm3 = item.node.featuredImage) === null || _item$node$featuredIm3 === void 0 ? void 0 : _item$node$featuredIm3.node.sourceUrl;
              return item && item.node && /*#__PURE__*/jsx_runtime.jsx(next_link["default"], {
                href: item.node.slug,
                children: /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
                  cursor: "pointer",
            ...
            var _item$node9, _item$node$featuredIm4;

            const author = item === null || item === void 0 ? void 0 : (_item$node9 = item.node) === null || _item$node9 === void 0 ? void 0 : _item$node9.author.node;
            const imagePath = (_item$node$featuredIm4 = item.node.featuredImage) === null || _item$node$featuredIm4 === void 0 ? void 0 : _item$node$featuredIm4.node.sourceUrl;
            return item && item.node && /*#__PURE__*/jsx_runtime.jsx(next_link["default"], {
              href: item.node.slug,
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
                cursor: 'pointer',
...
function PageData({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/jsx_runtime.jsx(seo_PageSeo, {
      data: data
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
      overflow: "hidden",
      px: {
...
function PostData({
  ...
  var _data$featuredImage;

  const author = data.author.node;
  const date = new Date(data.date);
  const imagePath = (_data$featuredImage = data.featuredImage) === null || _data$featuredImage === void 0 ? void 0 : _data$featuredImage.node.sourceUrl;
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Flex, {
      ...
      children: [/*#__PURE__*/jsx_runtime.jsx(chakra_ui_react_cjs_prod.Text, {
        ...
        columns: 1,
        spacing: 2,
        children: [/*#__PURE__*/jsx_runtime.jsx(lib.FacebookShareButton, {
          url: post_link,
...
const Trending = ({
  ...
  const Trendinglist = [1, 2, 3, 4]; // console.log('checktrending', props.trending);
  // store data
...
function Post({
  ...
  const data = props.data.post; // const tags = data?.tags?.edges;
  ...
  const videoLink = `https://www.youtube.com/embed/${data.youtube.videoId}`; // console.log('checkpostdata', props);

  const listdata = [1, 2, 3, 4, 5, 6]; // const Trending = [1, 2, 3, 4];
  //  const tags = data.tags.edges;
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/jsx_runtime.jsx(seo_PageSeo, {
      data: data
    }), data.youtube.videoId !== null && data.youtube.videoId !== undefined && data.youtube.videoId !== '' ?
    /*#__PURE__*/
    ...
    /*#__PURE__*/
    // </Box>
    jsx_runtime.jsx(chakra_ui_react_cjs_prod.Img, {
      objectFit: 'cover',
      src: imagePath,
      w: '100%'
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)(chakra_ui_react_cjs_prod.Box, {
...
var error = __webpack_require__(72445);
...
function OtherPages(props) {
  ...
  if (router.isFallback) {
    ...
    const pageType = props.pageType; // console.log('checkpagetype', props);
    //if found any data
...
async function getStaticProps(context) {
  ...
  var sectionCData = await (0,api/* getCateogryRecentPostbyName */.Yd)('categoryName', {"SECTION_A":{"NAME":"TOP NEWS","DESC":"The latest entertainment news in the world","SLUG":"/category/social-news"},"SECTION_B":{"NAME":"Opinion","DESC":"The latest entertainment news in the world","SLUG":"/category/social-news"},"SECTION_C":{"NAME":"Features","DESC":"The latest entertainment news in the world","SLUG":"/category/social-news"}}.SECTION_C.NAME); //get data
  ...
  const menuData = await (0,api/* getHeaderMenuByName */.BV)("Main menu"); //console.log('pagetype', pageType);
...
async function getStaticPaths() {
  const allPosts = await (0,api/* getAllPostsWithUri */.ST)(); //const mostVisitedUri = ['/fantasy-cricket/dream11-investment-strategy-5-years-of-experience/']

  const categoryListUri = ['/category/coins', '/category/news', '/category/editors-pick', '/category/academy', '/category/reviews', '/category/top-news', '/category/video'];
  const postListUri = allPosts.edges.map(({
    node
  }) => `${node.uri}`);
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(97103)
...
var __webpack_exports__ = __webpack_require__.X(0, [848,292,758,102,482,445], () => (__webpack_exec__(89538)));

...
export async function parseComment(id, content, author) {
  console.log('trisha', content);
  const data = await fetchAPI(
    `
  mutation CREATE_COMMENT( $id:Int ,$content:String,$author:String  ) {
  createComment(input: {
    commentOn: $id, 
    content: $content, 
    author: $author
